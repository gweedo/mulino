...
class InMemoryPizzaRepository(PizzaRepository):
    """In-memory implementation of PizzaRepository.

    First-class implementation so non-test consumers (CLI dry-run, fast smoke
    paths, doc snippets) can use it without reaching into tests/.
    """
