...
The implementation plan is internal tooling state (lives under `.claude/`, gitignored). A tracked `docs/` tree will be generated by step 17 of the plan; until then, `git log --oneline` is the canonical record of decisions.
